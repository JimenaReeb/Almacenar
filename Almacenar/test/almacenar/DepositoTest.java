...
public class DepositoTest {
    ...
    public void testAgregar() {
        ...
        for(int i=0;i<cantidadDeposito;i++){
            assertFalse("Fallo al agregar paquete a deposito",deposito.agregar(paquetes[i]));
            assertFalse("Debe fallar al agregar el mismo paquete dos veces",deposito.agregar(paquetes[i]));
        ...
        for(int i=cantidadDeposito;i<cantidadPaquetes;i++){
            assertFalse("Fallo si me permite agregar màs paquetes que el lìmite",deposito.agregar(paquetes[i]));
        }
    }
    @Test
    public void testGetPaquetes() {
        ...
        while(iterador.hasNext()&&cantidad<cantidadDeposito){
            ...
            assertTrue("Fallo no retorna paquetes en orden correcto",paquetes[cantidad]==paquete);
